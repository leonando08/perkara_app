                    ...
                    <div class="content-card mb-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                ?>
                                <input type="date" name="status_perkara_tk_banding_date" id="status_perkara_tk_banding_date_user" class="form-control" value="<?= $existing_date ?>">
                                <input type="hidden" name="status_perkara_tk_banding" id="status_perkara_tk_banding_user" value="<?= htmlspecialchars($perkara->status_perkara_tk_banding) ?>">
